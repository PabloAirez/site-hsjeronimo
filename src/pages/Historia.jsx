...
const Historia = () => {
  ...
  return (
    ...
    <CardText title={"Nossa Visão:"} text={"Ser referência do Sistema Único de Saúde na Região Metropolitana do Rio Grande do Sul, até 2020."} top={"10%"} left={"55%"} right={"0%"} bottom={"auto"}></CardText>
