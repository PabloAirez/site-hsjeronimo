...
useState(
  ...
  return (
    ...
    <div className={`w-1/2 lg:w-1/4 flex-none xl:w-1/5 hover:bg-secondaryColor hover:border-solid hover:border-2 hover:border-white duration-100 group ${classNameCard}`}>
